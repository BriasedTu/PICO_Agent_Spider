...
class GDTHtmlParser:
    ...
    def _parse_cell_with_nested_tables(self, td, outer_table, tree):
        ...
        nested_tables = [self._extract_table_object(nt, tree) for nt in self._get_direct_nested_tables(td, outer_table)]
        if nested_tables:
            if own_text:
    ...
    def _table_to_grid(self, table_el, tree):
        ...
        for tr in trs:
            ...
            for cell in tr.xpath("./th|./td"):
                ...
                nested = [self._extract_table_object(nt, tree) for nt in self._get_direct_nested_tables(cell, outer_table=table_el)]
                if nested:
