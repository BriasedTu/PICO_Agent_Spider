...
GET_RESULT_API = "https://mineru.net/api/v4/extract-results/batch"
POLL_INTERVAL = 30  # 秒，轮询间隔
MAX_RETRIES = 10    # 最大轮询次数
BATCH_SIZE = 150    # 每批文件数量
save_path = r'E:\Python Project\Spider\PICO_Agent\PDFTEST\SAVE'
...
def process_batch(files: List[str], batch_id: str = "") -> Tuple[str, List[Dict]]:
    ...
    # 2. 上传文件
    for file_path, url in zip(files, upload_urls):
        try:
...
if __name__ == "__main__":
    # 配置文件夹路径
    PDF_FOLDER = r"E:\Python Project\Spider\PICO_Agent\PDFTEST"  # 替换为实际文件夹路径
